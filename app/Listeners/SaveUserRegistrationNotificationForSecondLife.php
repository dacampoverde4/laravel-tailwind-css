...
class SaveUserRegistrationNotificationForSecondLife
{
    ...
    {   
        ...
        if($event->user) {
            ...
            if($event->user->uuid) {
                $dName=$event->user->displayname;
                $site="[http://www.avdopt.com AvDopt]";

                $slMessage = "Congratulations ".$dName."! Your new ".$site." account has been created. Welcome to the revolution of adoption in Second Life.";

                $slMessage .= "\n\nAlthough recently launched, ".$site." has been around for quite some time. In fact, over the last 3 years our team of developers have been working assiduously to provide you with the best adoption experience Second Life has to offer. Simply, because you deserve only the best.";

                $slMessage .= "\n\nWhether you're looking to adopt or to be adopted, ".$site." is everything you've searched for. Take advantage of our free & premium services like: Notes, Chat, Match Quest, Trial Dates & so much more.";

                $slMessage .= "\n\nYou've made your first step towards excellence, and we're with you every step of the way. Welcome to ".$site." ".$dName."; we are the 'A' in 'Adoption.' ";
