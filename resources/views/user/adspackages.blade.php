...
<div class="container-fluid">
    <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        @endif
                            ...
                            <ul class="nav nav-tabs">
                              <li class="active"><a data-toggle="tab" href="#Advertise">Advertise</a></li>
                              <li><a data-toggle="tab" href="#my_campaigns">My Campaigns</a></li>
                            </ul>
        ...
        <div id="my_campaigns" class="tab-pane fade blanlspace">
            <div class="card-body">                    
                 
                <center><h3 class="Advertsub atrt"><i>You have no advertisement campaigns.</i></h3></center>
                </div>  
