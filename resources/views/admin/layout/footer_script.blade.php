<!-- All Jquery -->
<!-- ============================================================== -->
<script src="{{ asset('new_theme_assets/plugins/jquery/jquery.min.js') }}"></script>
...
<script src="{{ asset('new_theme_assets/plugins/color/color.js') }}"></script>
<script src="{{ asset('new_theme_assets/plugins/colorpicker/bootstrap-colorpicker.js') }}"></script>
<script src="{{ asset('new_theme_assets/plugins/bootbox-datepicker/bootstrap-datepicker.min.js') }}"></script>
