    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <h3 class="inline_block"><b>Update Job</b><a class="btn btn-primary pull-right" href="{{ url('admin/jobs') }}"><i class="fa fa-arrow-left"></i> Back</a>
                        </h3>
                        <hr>
                    @if (session('success'))
                    ...
                    @endif
                    <form class="form_inline fullwidth mtop40" method="POST" enctype="multipart/form-data" action="{{route('update.jobs', $job->id)}}">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label for="salary" class="col-md-4 col-form-label text-md-right">{{ __('Upload image') }}</label>
                                <div class="col-md-8">
                                    <input id="image" style=" position: relative; bottom: 25px;     margin-bottom: -26px;" type="file" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" name="image" value="{{ $job->image }}" >
