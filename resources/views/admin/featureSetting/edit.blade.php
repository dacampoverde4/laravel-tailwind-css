    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <h3 class="inline_block"><b>Featur Setting</b>
                    ...
                    <form class="form_inline fullwidth mtop40" method="POST" action="{{route('admin.feature.setting.update', $featuresetting->id)}}">
                        ...
                        <div class="form-group">
                           <div class="row">
                            ...
                            <div class="col-md-8">
                                <input id="amount" type="number" class="form-control{{ $errors->has('amount') ? ' is-invalid' : '' }}" name="amount" value="{{ $featuresetting->amount_days }}" required >
                        ...
                        <div class="form-group" class="form-control">
                           <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea id="description" name="info" class="form-control">{{ $featuresetting->info }}</textarea>
                                @if ($errors->has('info'))
                                <span class="invalid-feedback">
