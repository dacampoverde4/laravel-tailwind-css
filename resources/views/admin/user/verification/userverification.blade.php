    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <h3 class="inline_block"><b>Add User Verification Questionnaires</b>
                        ...
                        @endif
                        <form class="form_inline fullwidth mtop40" name="myForm" onsubmit=""
                            action="{{route('userverification.submit')}}" method="POST">
                            @csrf
                            <!-- INPUT -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text"
                                                ...
                                                id="question" name="question_title" autofocus>
                           ...
                           <!--      <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-4"><label for="answertype">Question Category</label></div>
                                        <div class="col-md-8">
                                            <select
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-4"><label for="answertype">User group</label></div>
                                        <div class="col-md-8">
                                            <select class="form-control searchdropdown" name="usergroups[]" multiple>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9"><button type="submit"
                                            class="btn btn-success pull-right border_radius"><i
                                                class="fa fa-check-circle" aria-hidden="true"></i> Submit</button></div>
                                </div>
                            </div>
                        </form>
                    </div>
