    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <h3 class="inline_block"><b>Edit Relationship</b>
                        <a class="btn btn-primary pull-right" href="{{route('admin.relationship')}}"><i class="fa fa-arrow-left"></i> Back</a></h3>
                        <hr>
                        @if (session('success'))
                       ...
                       @endif
                       <form class="form_inline fullwidth mtop40" method="POST" action="{{route('admin.relationship.update',$relationship->id )}}">
                        @csrf
                        <div class="form-group">
                           <div class="row"> 
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control" name="title" value="{{ $relationship->title }}" required style="text-transform: capitalize !important;">
