    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <h3 class="inline_block"><b>Edit Terminal</b>
                        ...
                        @endif
                        <form class="form_inline fullwidth mtop40" action="{{ route('terminal.update', $terminal->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                    <input type="text" class="form-control" name="terminal_id" placeholder="Terminal Id" value="{{$terminal->terminal_id}}">
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                    <input type="text" class="form-control" name="parcel_name" placeholder="Terminal Parcel Name" value="{{$terminal->parcel_name}}">
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                    <input type="text" class="form-control" name="region_name" placeholder="Terminal Region Name" value="{{$terminal->region_name}}">
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                    <input type="text" class="form-control" name="x" placeholder="X value" value="{{$terminal->x}}">
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                    <input type="text" class="form-control" name="y" placeholder="Y value" value="{{$terminal->y}}">
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                    <input type="text" class="form-control" name="z" placeholder="Z value" value="{{$terminal->z}}">
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                    <input type="text" class="form-control" disabled name="rank" placeholder="Terminal rank" value="{{$terminal->rank}}">
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <select name="status" id="" class="form-control">
                                        ...
                                        <option @if($terminal->status==1) selected @endif value="0">Activated</option>
                                    </select>
                                    </div>
