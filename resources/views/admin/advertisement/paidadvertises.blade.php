                            ...
                            <div class="container-fluid">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            @foreach($sub_advertisement as $value)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>@if($value['adevertisementlist']) {{ $value['adevertisementlist']['title'] }} @endif</td>
                                                <td>@if($value['userdata']) {{ $value['userdata']['displayname'] }} @endif</td>
                                                <td>{{$value->status}}</td>
                                                <td>{{ $value->paid == 1 ? 'Yes' : 'No' }}</td>
                                                  
                                                <td>
                                                    @if(count($value['userbanners']) == 0 && $value->status == 'Inactive')
                                                    ...
                                                    @elseif(count($value['userbanners']) > 0 && $value->approve == 1)
                                                    ...
                                                    @elseif($value['userbanners'] != '' && $value->status == 'Inactive')
